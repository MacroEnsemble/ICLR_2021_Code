...
# from atari_doom.atari_doom import AtariDoom
# import 
# exit(0)

DOOM_CONFIG_PATH = '../ViZDoom/scenarios/'
def make_doom_env(env_id, num_env, seed, wrapper_kwargs=None,
                   start_index=0, allow_early_resets=True, start_method=None, extra_wrapper_func=None, logdir=None):
    """
    ...
    def make_env(rank):
        def _thunk():
            ...
            env_id_ = os.path.join(DOOM_CONFIG_PATH, env_id) 
            env = AtariDoom(env_id_)
            env.seed(seed + rank)
